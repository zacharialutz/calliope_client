	...
	return (
		<div>
			...
			<section className='aboutApp'>
				<p>This storytelling app is named after Calliope (kə-LY-ə-pee), the Greek muse of writing and eloquence. It was created in 2019 by Zacharia Lutz for the Thinkful Engineering Immersion program. It uses a database of thousands of nouns, verbs, and adjectives to create intruiging and hilarious short stories which can be enjoyed as they are, or expanded upon for whatever purpose you desire!</p>
